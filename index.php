...
<!--<![endif]-->
	<head>
		...
		<link type="text/css" id="colors" rel="stylesheet" href="css/design.css">
			...
			<header id="mainHeader" class="navbar-fixed-top" role="banner">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-5 col-sm-6 hidden-xs">
								<img src="images/theme-pics/home-main.png" alt="CustomerPath" class="img-responsive"/>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="slice" id="features">
					<div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
                                <p>Through SDKs integrated in the customer apps, CustomerPath enables you to observe customer behavior inside your store or venue and leverage Salesforce to understand your customer base through real-time actionable real-life metrics.<br><br></p>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-6">
				...
				<section class="slice color1" id="api">
						...
						<div class="row">
							...
							<article class="col-sm-4">
								...
								<section class="newsText color4">
									...
									<ul>
                                    	<li>SDK integrated into your existing loyalty app</li>
				...
				<!-- api -->
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-sm-6 col-md-3">
									<article>
										<div><img src="images/team/brad.jpg" alt="" class="img-responsive"></div>
								...
								<div class="col-sm-6 col-md-3">
									<article>
										<div><img src="images/team/max.jpg" alt="" class="img-responsive"></div>
										<div class="boxContent color4">
											<h3>Max Domain</h3>
								...
								<div class="col-sm-6 col-md-3">
									<article>
										<div><img src="images/team/laura.jpg" alt="" class="img-responsive"></div>
										<div class="boxContent color4">
											<h3>Laura Jensen</h3>
											
										</div>
										<div class="teamemail"> <a href="mailto:design@designlaurels.com">design@designlaurels.com</a>
                                ...
                                <div class="col-sm-6 col-md-3">
									<article>
										<div><img src="images/team/harvey.jpg" alt="" class="img-responsive"></div>
										<div class="boxContent color4">
											<h3>Harvey Chan</h3>
                               ...
                               <div class="col-sm-6 col-md-3">
									<article>
										<div><img src="images/team/prateek.jpg" alt="" class="img-responsive"></div>
										<div class="boxContent color4">
											<h3>Prateek Gupta</h3>
					...
					<section class="slice color1"  id="signupSlice" >
						<div class="container">
							<div class="row">
					...
					<div class="maskParent">
						...
						<section  id="footerRights">
							<div class="container">
								<div class="row">
									<div class="col-sm-12">
										<p>Copyright © 2013 CustomerPath. All rights reserved.</p>
									</div>
